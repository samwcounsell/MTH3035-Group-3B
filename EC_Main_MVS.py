...
df = pd.read_csv("september_trend_mvs.csv")
...
l585t = df585['mvs'].to_numpy()

slope585, intercept585, r_value585, p_value585, std_err585 = scipy.stats.linregress(l585, l585t)

print(r_value585)

fig126 = px.scatter(df126, x="ssp126", y="mvs", trendline="ols")
fig126.show()

fig245 = px.scatter(df126, x="ssp245", y="mvs", trendline="ols")
fig245.show()

fig585 = px.scatter(df585, x="ssp585", y="mvs", trendline="ols")
fig585.show()
